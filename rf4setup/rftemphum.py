...
def programsensor(devid, newdevid, interval):
    ...
    if rf4 == 0:
        ...
        programsensorR2(devid, newdevid, interval, rf4, 10)
    else:
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Configure RF Temperature/Humidity Sensor")
        helpmessage("rftemphum.py")
    if len(sys.argv) < 4:
        interval = 5
    else:
    ...
    print("Configuring Temp/Humidity sensor with ID >>" + str(sys.argv[1]) +
