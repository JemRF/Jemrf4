...
def programsensor(devid, newdevid, interval):
    ...
    programcloseout(newdevid,rf4, 1)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Configure RF Power Sensor with temperature option")
        helpmessage("rfpower.py")
    if len(sys.argv) < 4:
        interval = 5
    else:
    ...
    print("Configuring RF Power Det Sensor with ID >>" + str(sys.argv[1]) +
